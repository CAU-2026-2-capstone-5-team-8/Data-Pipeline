...
def operating_system_concepts_page(parts: tuple[tuple[str, tuple[str, ...]], ...]) -> str:
    ...
    dataset = normalize_public_book_page_response(
        {
            ...
            "url": source.url,
            "html": operating_system_concepts_page(parts),
        },
        topic=source.topic,
...
def test_operating_system_concepts_rejects_chapter_under_wrong_part() -> None:
    source = public_book_source("ecampus-osc10")
    parts = (
        ("Part 1 Overview", ("1 Introduction", "2 Operating-System Structures", "3 Processes")),
        ("Part 2 Process Management", ("4 Threads & Concurrency", "5 CPU Scheduling")),
        (
            "Part 3 Process Synchronization",
            ("6 Synchronization Tools", "7 Synchronization Examples", "8 Deadlocks"),
        ),
